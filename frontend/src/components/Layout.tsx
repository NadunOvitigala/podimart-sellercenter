    ...
    <>
      ...
      <header className="site-header">
        <div className={`wrap header-row${menuOpen ? " is-menu-open" : ""}`}>
          <NavLink to={loggedIn ? "/dashboard/listings" : "/"} className="brand" onClick={closeMenu}>
          ...
          <nav id="seller-nav" className={menuOpen ? "nav is-open" : "nav"}>
            ...
            <div className="nav-actions">
              {loggedIn ? (
                <>
                  <div className="nav-dropdown nav-shop-desktop" ref={shopMenuRef}>
                    <button
                      type="button"
                      className={
                        shopOpen
                  ...
                  <div className="nav-shop-mobile">
                    <p className="nav-section-label">My shop</p>
                ...
                <>
                  <NavLink to="/login" className="nav-quiet" onClick={closeMenu}>
                    Log in
                  </NavLink>
                  <NavLink to="/signup" className="btn btn-clay nav-cta" onClick={closeMenu}>
      ...
      {loggedIn ? (
        <nav className="mobile-tabbar" aria-label="Seller tools">
          ...
          <NavLink
            to="/dashboard/new"
            className={({ isActive }) => (isActive ? "tabbar-item is-active tabbar-primary" : "tabbar-item tabbar-primary")}
          >
